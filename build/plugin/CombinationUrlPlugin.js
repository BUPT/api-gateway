...
class CombinationUrlPlugin {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            xml2js.parseString(flowData, function (err, result) {
                if (err) {
                    ...
                    let combinationUrlPlugin = new CombinationUrlPlugin();
                    ...
                    let combinationUrl = {
                        url: serviceName, atom_url: (combinationUrlPlugin.getApiIdFromFlow(result).join(",")),
                        flow_xml: flowData
                    };
                    // 将结果插入数据库
    ...
    combinationService(req, res) {
        ...
        let id = combinationUrlPlugin.getApiIdFromFlow(flowJson);
        let apiInfo = combinationUrlPlugin.getApiInfo();
        let config = new config_1.Config();
        // 存储原子API的url
        let url = [];
...
exports.CombinationUrlPlugin = CombinationUrlPlugin;
